...
test("background handles toolbar toggle and editable context menus", () => {
  ...
  assert.match(script, /importScripts\("src\/field-meta\.js",\s*"src\/field-visibility\.js",\s*"src\/site-feature-toggle\.js",\s*"src\/smart-fill\.js",\s*"generated\/data-manager-bridge\.js"\)/);
