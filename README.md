...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v0.9.1-4a6fa5?style=flat-square" alt="version">
...
- 智能识别输入框类型，并在输入框旁显示快速填充按钮；展开五星按钮可将当前页面已识别的非空字段添加为一组常用数据。
...
1. 在 [GitHub Releases](https://github.com/coldShan/place-fill/releases) 下载最新的 `place-fill-v0.9.1.zip`。
