...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v0.8.0-4a6fa5?style=flat-square" alt="version">
...
- 支持人工标注导入、导出、脱敏导出，以及全部数据备份/恢复；每周五上午 10 点通过悬浮球提醒备份，页面暂不可用时会自动补发，提醒持续显示至手动关闭。

## 安装

1. 在 [GitHub Releases](https://github.com/coldShan/place-fill/releases) 下载最新的 `place-fill-v0.8.0.zip`。
