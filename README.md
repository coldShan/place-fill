...
- 支持手机号、身份证号、姓名、银行卡号、统一社会信用代码等常见字段场景
- 包含 hover、copy、高亮脉冲与吸附滑入等轻量交互动效

## 界面预览

![测试数据面板](./assets/img1.png)

![智能填充按钮](./assets/img2.png)
...
5. 导入后会显示插件名 `place-fill`，当前版本是 `0.3.2`
...
- 发布 zip 只包含 `extension/` 目录内容，产物文件名会自动带上 `manifest.json` 里的版本号，例如 `releases/place-fill-v0.3.2.zip`：
