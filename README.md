...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v0.9.8-4a6fa5?style=flat-square" alt="version">
  <img src="https://img.shields.io/badge/Chrome-MV3-4285F4?style=flat-square&logo=googlechrome&logoColor=white" alt="chrome mv3">
</p>

## 核心功能

- **一键填表**：生成姓名、手机号、身份证号、公司名称、统一社会信用代码、邮政编码等常用中文测试数据，支持单项复制、整组复制和自动填充。
...
1. 从 [GitHub Releases](https://github.com/coldShan/place-fill/releases) 下载 `place-fill-v0.9.8.zip` 并解压。
