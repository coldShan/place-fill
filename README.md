...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v0.8.2-4a6fa5?style=flat-square" alt="version">
...
- 右侧悬浮面板支持单项复制、整组复制、重新生成和页面自动填充；悬浮球划过后可直接一键填充、导出或导入全部数据。
...
1. 在 [GitHub Releases](https://github.com/coldShan/place-fill/releases) 下载最新的 `place-fill-v0.8.2.zip`。
