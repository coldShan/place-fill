...
<p align="center">
  <img src="https://img.shields.io/badge/版本-v0.7.1-4a6fa5?style=flat-square" alt="version">
...
- 支持**导入**已有标注，跨设备迁移
- 人工标注存储在扩展的 `chrome.storage.local`，不依赖业务页面缓存
...
1. 前往 [GitHub Releases](https://github.com/coldShan/place-fill/releases) 下载最新的 `place-fill-v0.7.1.zip`
2. 解压到本地任意目录
...
- 基础表单靶场：`mock-form/index.html`
- Element UI 霓虹边框复现页：`mock-form/element-ui-demo.html`
